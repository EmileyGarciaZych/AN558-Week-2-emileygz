...
> *Similarly to the above parts, use the matrix function to extract the elements.*
...
> *I wasn't fond of the way this formatted the lists so I researched how to make a data tree in R. You can do this by installing a package to make a data tree and then creating nodes at every split from the original primate line. It ended up being convoluted and a little messy but I wanted to include it here.*
...
e)  **When you are done, use the str() command to show the data type for each variable in your data frame.**
